...
<jsp:include page="/member/header.jsp" />
	...
	<main class="page-wrap intro">
		...
		<section id="mission">
			<p>
			저희 팀은 뉴스 웹사이트를 만들어보았습니다.
			 우리 팀은 신문사 웹사이트를 모티브로 하여, <br />뉴스 기사를 작성하고 관리할 수 있는 기능과 함께 다양한 카테고리와 태그를 제공하여 쉽게<br /> 원하는 뉴스를 찾을 수 있도록 구성하였습니다.<br />
			
			또한, 구독 기능을 제공하여 사용자들이 원하는 카테고리의 뉴스를 손쉽게 받아볼 수 있도록 하였으며,<br />검색 기능을 통해 빠르고 정확하게 원하는 뉴스를 검색할 수 있도록 구현하였습니다. <br />
			우리 팀은 뉴스 웹사이트를 개발하며 다양한 기술들을 배우고 적용해보았습니다. <br />이를 통해 팀원들 간의 협업 능력을 향상시키고, 실제 개발 프로젝트에서 <br />필요한 기술과 역량을 키울 수 있었습니다.</p>
		</section>
